...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
	<div
		ref={ref}
		className={cn(
			"rounded-lg border border-neutral-200/60 bg-gradient-to-tl from-white from-60% to-emerald-100/30 to-100% p-4 shadow-sm dark:border-neutral-700/50 dark:from-[#242424] dark:from-60% dark:to-emerald-100/10 dark:to-100% dark:shadow-black/20",
			className
		)}
		{...props}
	/>
