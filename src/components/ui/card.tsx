...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
	<div
		ref={ref}
		className={cn(
			"rounded-lg border border-neutral-200/70 bg-gradient-to-tl from-white from-60% to-[#f8fffd] p-4 shadow-md shadow-neutral-300/40 dark:border-neutral-700/50 dark:from-[#202020] dark:from-60% dark:to-[#252a29] dark:shadow-black/10",
			className
		)}
		{...props}
	/>
